...
```
$ docker image tag gateway genvitatest/gateway
$ docker push genvitatest/gateway
$ docker image tag blog genvitatest/blog
$ docker push genvitatest/blog
$ docker image tag store genvitatest/store
$ docker push genvitatest/store
```
