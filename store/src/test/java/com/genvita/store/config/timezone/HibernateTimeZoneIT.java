package com.genvita.store.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.genvita.store.IntegrationTest;
import com.genvita.store.repository.timezone.DateTimeWrapper;
import com.genvita.store.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM store_date_time_wrapper where id=%d", fieldName, id);
    }
